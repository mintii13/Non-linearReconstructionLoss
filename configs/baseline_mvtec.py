...
class cfg(cfg_common, cfg_dataset_default, cfg_model_uniad):
    ...
    def __init__(self):
        ...
        self.model_backbone.kwargs = dict(pretrained=True, checkpoint_path='', strict=False, hf=None, features_only=True, out_indices=[0, 1, 2, 3])
        ...
        self.wandb.project = "Non-linear_MVTec" 
        self.wandb.entity = None 
        self.wandb.name = 'Baseline_Sigmoid90_500_lr0.0001_seede42'
